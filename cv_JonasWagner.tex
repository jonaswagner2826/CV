...
\cvitem{Basic}{C/C++/C\#, VBA, putty}
\cvitem{Proficient}{Simulink, Mathematica, Linux, Git, \LaTeX}
\cvitem{Advanced}{\textsc{Python}, numpy, matplotlib, MATLAB}

\subsection{\textbf{Engineering Tools}}
\cvitem{Proficient}{AutoCAD, ANSYS Workbench, Solidworks}
\cvitem{Advanced}{Autodesk Inventor}
...
\printbibliography[keyword = presentation, title={Presentations}]
